      ...
      >
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Manage your saved audio projects with effects
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              {projects.map((project, index) => {
                ...
                return (
                  <motion.div
                    ...
                    style={{ originY: 0 }}
                  >
                    <Card className="relative border-0 shadow-sm hover:shadow-md transition-shadow duration-200 bg-gradient-to-r from-card to-card/50">
